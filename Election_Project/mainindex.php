...
<div class="container-fluid text-center ">
        ...
        <div class="text-center ">
                <h5 class="header-description  header-desc">तक्रार नोंदवण्यासाठी कृपया वैध मतदार, वार्ड क्रमांक <br>आणि मोबाइल क्रमांक प्रविष्ट करा.</h5>
            </div>
    ...
    <small class="text-danger" id="voterIdError" style="display: none;">Voter ID must be exactly 10 characters long.</small>
        ...
        <div class="d-flex justify-content-center mt-4 ">
            ...
            <button id="stepButton2" class="step-btn two" disabled>2</button>
            <span class="arrow two">→</span>
            <button id="stepButton3" class="step-btn" disabled>3</button>
        </div>
        </section>
        ...
        <input type="hidden" id="pb_address" class="form-control" >
                    ...
                    <div class="form-row row g-3 text-center">
                        <div class="col-12 resendotpdiv">
                            <a href="#" class="text-white resendotp" style="font-size: medium;">ओ. टी. पी. पुन्हापाठवा</a>
                        </div>
                    </div>
    ...
    <div class="form-check-box mb-3">
        ...
        <div class="d-flex justify-content-center mt-3">
            ...
            <span  class="arrow lastfirst ">→</span>
            <button id="stepButton8" class="step-btn lasttwo" disabled>2</button>
            <span class="arrow lastsecond">→</span>
            <button id="stepButton9" class="step-btn lastthree active" disabled>3</button>
        </div>
        </section>
